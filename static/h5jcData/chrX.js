var htmlStr_1 = `<div id="navsecond">

<div id="course"><h2>CSS 基础教程</h2>
<ul>
<li><a href="../html/html_intro.htm" title="HTML教程">**HTML**</a></li>
<li><a href="../js/js_intro.htm" title="JavaScript 教程">**JS**</a></li>
...
<h2>CSS 样式</h2>
<ul>
<li><a href="css_border_outline.htm" title="边框 轮廓">边框 轮廓</a></li>
...
<li><a href="css3_flexbox.html" title="弹性盒">弹性盒</a></li>
...
<li><a href="css_dimension_units.htm" title="尺寸单位">尺寸单位</a></li>
<li><a href="css_colors_legal.htm" title="颜色">颜色</a></li>
<li><a href="cssRefIndex.htm" title="CSS3 参考手册">CSS3 参考手册</a></li>
<li>---</li>
<li><a href="csse_examples.htm" title="CSS 实例">CSS 实例</a></li>
</ul>
...
<h2><a href="css_positioning.htm" title="CSS 定位概述">CSS 定位</a></h2>
<ul>
...
<li><a href="css_selectors.htm" title="CSS 选择器参考">CSS 选择器参考</a></li>
...
var htmlStr_4 = `<div id="navsecond">
...
var htmlStr_6 = `<div id="navsecond">
<div id="course">
<h2>JavaScript 核心</h2>
<ul>
...
var htmlStr_svg = `<div id="navsecond">
<div id="course"><h2>SVG 基础</h2>
<ul>
<li><a href="index.htm" title="SVG 教程">SVG 教程</a></li>
<li><a href="svg_intro.htm" title="SVG 简介">SVG 简介</a></li>
<li><a href="svg_example.htm" title="SVG 一个例子">SVG 实例</a></li>
<li><a href="svg_inhtml.htm" title="在 HTML 文档中的 SVG">SVG in HTML</a></li>
</ul>
<h2>SVG 形状</h2>
<ul>
...
<h2>SVG 渐变</h2>
<ul>
<li class="currentLink"><a href="svg_grad_linear.htm" title="SVG 线性渐变">SVG 线性渐变</a></li>
...
var htmlStr_sql = `<div id="navsecond">
...
var htmlStr;
if(location.href.indexOf('/css/') >= 0)
	htmlStr = htmlStr_1;
else if(location.href.indexOf('/cssref/') >= 0)
	htmlStr = htmlStr_2;
else if(location.href.indexOf('/html/') >= 0) 
	htmlStr = htmlStr_3;
else if(location.href.indexOf('/tags/') >= 0) 
	htmlStr = htmlStr_4;
else if(location.href.indexOf('/js/') >= 0) 
	htmlStr = htmlStr_5;
else if(location.href.indexOf('/jsref/') >= 0) 
	htmlStr = htmlStr_6;
else if(location.href.indexOf('/svg/') >= 0)
	htmlStr = htmlStr_svg;
else if(location.href.indexOf('/sql/') >= 0)
	htmlStr = htmlStr_sql;
else if(location.href.indexOf('/other/') >= 0)
    htmlStr = "";
else htmlStr = htmlStr_1;

var wrapperE = document.getElementById('wrapper');
wrapperE.innerHTML = htmlStr + '\n' + wrapperE.innerHTML;
...
<div id="resizeImg" 
    style="cursor:ne-resize;display:none;position:fixed;width:57px; height:57px;background-image:url(../i/scale.png);background-repeat:no-repeat;background-position:center center;">
</div>`;
...
tiy.run = function(cmdStr){
	...
	tiy_iframe_code.width = 300;
	tiy_iframe_code.height = 400+ tiy.f; //修改iframe大小以触发onresize事件，执行相应功能
	tiy.f = tiy.f == 0 ? 1 : 0;
	...
	resizeImg.onmousedown = function(e){
		...
		resizeImg.onmousemove = function (e){
			...
			tiy_iframe_code.width = parseInt(tiy_iframe_code.width.replace("px","")) - diffX
			tiy_iframe_code.height = parseInt(tiy_iframe_code.height.replace("px","")) + diffY
...
document.body.innerHTML = 
    `<header>
	<nav>
		<a href="/static/h5jcData/html/html_intro.htm">html5</a>
		<a href="/static/h5jcData/css/css_intro.htm">css3</a>
		<a href="/static/h5jcData/js/js_intro.htm">javascript</a>
		<a href="/static/h5jcData/other/index.htm">other</a>
        <a href="/">chrX</a>
	</nav>
    </header>`
